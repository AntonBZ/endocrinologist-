...
// Генерація доступних дат на 30 днів вперед (без вихідних)
...
export default function BookingPage() {
  ...
  const stepLabel = ['', 'Дані пацієнта', 'Дата і час', 'Оплата']
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      rows={3}
                      placeholder="Опишіть симптоми або питання..."
                      value={form.notes}
                ...
                {selectedDate && (
                  <div>
                    <p className="text-xs text-gray-500 mb-2">
                      Вільний час на {format(selectedDate, "d MMMM", { locale: uk })}:
                    </p>
            ...
            {step === 3 && (
              <div>
                ...
                <p className="text-xs text-gray-500 mb-3">🔒 Оплата захищена SSL. Після оплати — підтвердження на email.</p>

                {/* LiqPay form — auto-submit після отримання даних */}
                {liqpayData ? (
                  <form method="POST" action="https://www.liqpay.ua/api/3/checkout" acceptCharset="utf-8">
                    ...
                    <button type="submit" className="w-full bg-yellow-500 hover:bg-yellow-600 text-white py-3 rounded-lg text-sm font-medium">
                  ...
                  >
                    {loading ? 'Обробка...' : '💳 Оплатити ' + service.price + ' ₴'}
                  </button>
                )}
